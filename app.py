...
def import_products():
    ...
    products = [
        ('2S10', 'SS-31 (10mg/10vials)', 75, 525, 'Peptides'),
        ('332', 'SLU-PP-332 (5mg/10vials)', 120, 840, 'Peptides'),
        ('375', 'LL37 (5mg/10vials)', 55, 385, 'Peptides'),
        ('5AD', 'AOD9604 (5mg/10vials)', 60, 470, 'Peptides'),
        ('5AM', '5-amino-1mq (5mg*10vials)', 65, 455, 'Peptides'),
        ('BB20', 'BPC 10mg + TB 10mg (20mg/10vials)', 60, 500, 'Blends'),
        ('BBG70', 'GLOW (BPC+GHK-CU+TB500) (70mg/10vials)', 98, 780, 'Blends'),
        ('BBGK', 'KLOW (BPC+GHK-CU+TB500+KPV) (80mg/10vials)', 186, 1065, 'Blends'),
        ('BC10', 'BPC 157 (10mg/10vials)', 37, 350, 'Peptides'),
        ('CBL60', 'Cerebrolysin (60mg/6vials)', 85, 595, 'Nootropics'),
        ('CD5', 'CJC-1295 DAC (5mg/10vials)', 140, 980, 'Growth Hormone'),
        ('CGL10', 'Cagrilintide (10mg/10vials)', 80, 560, 'Weight Management'),
        ('CND10', 'CJC-1295 NO DAC (10mg/10vials)', 130, 910, 'Growth Hormone'),
        ('CP10', 'CJC-1295 NO DAC + IPA5mg (5mg+5mg/10vials)', 80, 550, 'Growth Hormone'),
        ('CS10', 'Cagrilintide+Semaglutide (5mg+5mg)', 85, 595, 'Weight Management'),
        ('CU50', 'GHK-CU (50mg/10vials)', 36, 278, 'Peptides'),
        ('DS15', 'DSIP (10mg/10vials)', 70, 490, 'Sleep'),
        ('ET10', 'Epithalon (10mg/10vials)', 35, 245, 'Anti-Aging'),
        ('F410', 'FOXO4 (10mg*10vials)', 270, 1890, 'Anti-Aging'),
        ('G5K', 'HCG (5000iu/10vials)', 75, 525, 'Hormones'),
        ('GTT', 'Glutathione (1500mg/10vials)', 100, 700, 'Antioxidants'),
        ('IP10', 'Ipamorelin (10mg/10vials)', 60, 420, 'Growth Hormone'),
        ('KPV10', 'KPV - LYSINE-PROLINE-VALINE (10mg/10vials)', 55, 385, 'Peptides'),
        ('KS10', 'KissPeptin-10 (10mg/10vials)', 50, 400, 'Peptides'),
        ('ML10', 'MT-2 Melanotan 2 Acetate (10mg/10vials)', 40, 280, 'Tanning'),
        ('MS10', 'MOTS-c (10mg/10vials)', 50, 350, 'Metabolic'),
        ('NJ1000', 'NAD+ (1000mg/10vials)', 100, 812, 'Longevity'),
        ('NJ500', 'NAD+ (500mg/10vials)', 70, 500, 'Longevity'),
        ('NP810', 'Snap-8 (10mg/10vials)', 40, 280, 'Cosmetic'),
        ('OT2', 'Oxytocin Acetate (2mg*10vials)', 250, 313, 'Hormones'),
        ('P41', 'PT-141 (10mg/10vials)', 55, 385, 'Peptides'),
        ('PI10', 'Pinealon (10mg/10vials)', 63, 500, 'Nootropics'),
        ('RT10', 'Retatrutide (10mg/10vials)', 80, 640, 'Weight Management'),
        ('SK5', 'Selank (5mg/10vials)', 40, 280, 'Nootropics'),
        ('SM10', 'Semaglutide (10mg/10vials)', 70, 490, 'Weight Management'),
        ('TA5', 'Thymosin Alpha-1 (5mg/10vials)', 65, 455, 'Immune'),
        ('TB10', 'TB500 Thymosin B4 Acetate (10mg/10vials)', 55, 500, 'Peptides'),
        ('TR10', 'Tirzepatide (10mg/10vials)', 70, 490, 'Weight Management'),
        ('TSM10', 'Tesamorelin (10mg/10vials)', 75, 500, 'Growth Hormone'),
        ('VIP10', 'VIP (10mg/10vials)', 140, 980, 'Peptides'),
        ('VIP5', 'VIP (5mg/10vials)', 75, 525, 'Peptides'),
        ('WA10', 'BAC Water (10ML/10vials)', 5, 50, 'Supplies'),
        ('XA5', 'Semax (5mg/10vials)', 40, 280, 'Nootropics'),
    ]
